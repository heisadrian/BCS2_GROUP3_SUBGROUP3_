  ...
  <div class="sm:flex">
    ...
    <div
      ...
      <div class="w-full lg:max-w-sm mx-auto space-y-10"
        ...
        <!-- title -->
        <div>
          <h2 class="text-2xl mt-5 font-semibold mb-1.5"> Sign in to your account </h2>
          <p class="text-sm text-gray-500 font-normal">If you haven’t signed up yet.
            <a href="form-register.php" class="text-blue-700">Register here!</a>
          </p>
        </div>


        <!-- form -->
        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="space-y-7 text-sm text-black font-medium
        ...
        cls: uk-animation-scale-up; delay: 100 ;repeat: true">
          ...
          <div>
            ...
            <div class="mt-2.5">
              <input id="email" name="email" type="text" autofocus="" placeholder="Email" required="" class="!w-full !rounded-lg !bg-transparent
          ...
          <div>
            ...
            <div class="mt-2.5">
              <input id="password" name="password" type="password" placeholder="******" class="!w-full !rounded-lg !bg-transparent
             !shadow-sm !border-slate-200 dark:!border-slate-800
             dark:!bg-white/5">
            </div>
          </div>
          ...
          <!-- submit button -->
          <div>
            <button type="submit" name="submit" class="button bg-primary text-white w-full">
              Sign in
            </button>
          </div>
